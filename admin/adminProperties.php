...
?>
      ...
      <?php
              if(isset($_POST['delete'])) {
                    ...
                    $msql = "DELETE  FROM Properties WHERE id = $ids";
                    $dresult = mysqli_query($conn, $msql);
                    if ($dresult) {
                      echo "property deleted";
                        // Redirect the user to the properties page
...
mysqli_close($conn);
            ...
            <form method="post">
              ...
              <input class="bookNowButton" type="submit" name="delete" value="Delete">
          </form>
